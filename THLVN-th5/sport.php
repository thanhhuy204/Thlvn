...
$sql_total = "SELECT COUNT(ID) as total FROM products WHERE Category='sports'";
...
// Truy vấn lấy sản phẩm thuộc danh mục 'sports' cho trang hiện tại
$sql = "SELECT * FROM products WHERE Category='sports' LIMIT $start, $limit";
    ...
    <div id="wrapper">
        ...
        <div class="pagination">
            ...
            if ($current_page > 1 && $total_page > 1) {
                echo '<a href="sport.php?page=' . ($current_page - 1) . '">Prev</a> | ';
            }
            ...
            if ($current_page < $total_page && $total_page > 1) {
                echo '<a href="sport.php?page=' . ($current_page + 1) . '">Next</a> | ';
            }
            ?>
        </div>
    </div>
